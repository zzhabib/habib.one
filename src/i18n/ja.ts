...
export const ja: Strings = {
  ...
  about: {
    title: '継続的にレベルアップしてる。',
    p1: '楽しいゲームと速いシステムを作るソフトウェアエンジニアです。Robloxで400万回以上プレイされたマルチプレイヤーカートレーシングゲーム「カートウォーズ」の開発をリードしました。CMEグループではリアルタイムリスク管理システムを構築しています。日本語を4年以上独学で学び続け、自分の限界を広げる次の挑戦を常に探しています。',
    statN2: '日本語能力試験N2合格',
